...
SRC = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
      ...
      ft_isdigit.c ft_isprint.c ft_itoa.c ft_split.c

OBJ = $(SRC:.c=.o)
NAME = libft.a
HEADER = libft.h

BONUSRC = ft_lstdelone_bonus.c ft_lstclear_bonus.c ft_lstiter_bonus.c ft_lstmap_bonus.c \
	  ft_lstadd_back_bonus.c ft_lstadd_front_bonus.c ft_lstlast_bonus.c ft_lstnew_bonus.c \
	  ft_lstsize_bonus.c
